...
[source]
----
$ mvn exec:java -Dexec.mainClass=TokenUtil -Dexec.classpathScope=test -Dexec.args="testUser 2017-09-15 Echoer Subscriber"
...
[source]
----
$ mvn exec:java -Dexec.mainClass=TokenUtil -Dexec.classpathScope=test -Dexec.args="testUser 2017-09-15 Echoer"
...
[source]
----
15:48:22,159 INFO  [org.jboss.resteasy.resteasy_jaxrs.i18n] (ServerService Thread Pool -- 78) RESTEASY002225: Deploying javax.ws.rs.core.Application: class App$Proxy$_$$_WeldClientProxy
...
Make the following changes to the previously created `SampleEndPoint` class.
...
As the project was created the class `App` was added, this should be modified by adding
